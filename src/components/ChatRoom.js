...
export default function ChatRoom(props) {
  ...
  return (<>
    ...
    <form onSubmit={sendMessage}>
      ...
      <input ref={focus} disabled={loading} value={formValue} onChange={(e) => setFormValue(e.target.value)} placeholder="Type your message here" />

      <button type="submit" className='send' disabled={!formValue}>Send
      </button>
